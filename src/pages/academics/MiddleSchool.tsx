      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-yellow-50 to-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Expanding horizons through comprehensive education and skill development.
          </p>
          ...
          <div className="mt-16 p-8 bg-yellow-50 rounded-lg">
            <p className="text-lg text-gray-600">
              This page is under development. Check back soon for detailed information about our middle school program, 
              faculty, curriculum, and activities.
            </p>
          </div>
        </div>
      </section>
