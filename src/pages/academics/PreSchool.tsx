    ...
    <div className="min-h-screen">
            ...
            <div className="rounded-xl overflow-hidden shadow-2xl">
              <div className="relative h-[400px]">
                <div className="absolute inset-0 bg-cover bg-center"
                  style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519398039097-a6e1fe8c1766?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')" }}
                ></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative h-64 overflow-hidden rounded-lg">
                <div 
                  ...
                  style={{ backgroundImage: "url('https://images.unsplash.com/photo-1545151504-298cb616fc3c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80')" }}
                ></div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-school-dark mb-4">
              Meet Our Pre-School Faculty
            </h2>
            <p className="text-gray-600 text-lg">
              Our experienced and dedicated teachers create a nurturing environment 
              where young children thrive and develop a love for learning.
            </p>
          </div>
