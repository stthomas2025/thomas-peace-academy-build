...
const BoardMembersSection = () => {
  const boardMembers = [
    ...
    {
      name: "Mr. Dhalendra Kumar Chudhary",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Meet our distinguished board members who guide our institution
            towards excellence.
          </p>
        </motion.div>
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {[...boardMembers, ...boardMembers].map((member, index) => (
              <motion.div key={index} className="flex-none w-72">
                <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-school-dark mb-1">
                      {member.name}
                    </h3>
                    <p className="text-school-primary font-medium">
                      {member.position}
                    </p>
                  </div>
                </div>
